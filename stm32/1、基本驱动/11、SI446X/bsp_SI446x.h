...
#include "bsp_spi_si4463.h"
#include "bsp_Si446x_Config_30M.h"


#define  PACKET_LENGTH      		32 		//0-64, 0:动态长度 1:固定长度
...
//#define SI4463_GPIO0_PIN			GPIO_Pin_10
...
#define SI_SET_CSN_LOW( )			spi_set_nss_low( )
 ...
 #define EZRP_NIRQ         GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_0)
/** SI4463 命令定义 */
typedef enum
{
    /*BOOT COMMANDS-------------------------------------*/
